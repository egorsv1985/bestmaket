		...
		<div class="main-slider position-relative ">
			<ul class="slides">
				<li class=" position-relative d-flex justify-content-center">
					<picture>
						<source srcset="<?= SITE_TEMPLATE_PATH; ?>/images/main.webp" type="image/webp">
...
<section class="portfolio py-5 d-none">
	<div class="container">
			...
			<div class="sample__box-content">
				<div class="sl-container">
					<div class="view view-after">
						<picture>
							<source srcset="<?= SITE_TEMPLATE_PATH; ?>/images/eskiz-black.webp" type="image/webp">
					...
					<div class="view view-before">
						<picture>
							<source srcset="<?= SITE_TEMPLATE_PATH; ?>/images/eskiz.webp" type="image/webp">
	...
	<div class="container">
		...
		<div class="advantages__content d-flex  align-items-lg-end ">
			<div class="advantages__box-img">
				<picture>
					<source srcset="<?= SITE_TEMPLATE_PATH; ?>/images/advantage.webp" type="image/webp">
					<img src="<?= SITE_TEMPLATE_PATH; ?>/images/advantage.png" alt="">
				</picture>
