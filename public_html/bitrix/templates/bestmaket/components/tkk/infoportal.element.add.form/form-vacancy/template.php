...
print_r($arResult["PROPERTY_LIST"]);
print_r($arParams["PROPERTY_CODES"]);
?>
...
-->
				...
				<div class="form-green ajax-form" id="smallForm_<?=$FORM_ID;?>">
					<div class="form-title">Рассказать о себе</div>
...
<?if(in_array($propertyID, $arResult["PROPERTY_REQUIRED"])):?> <span class="starrequired">*</span><?endif?>
							...
							<div class="file-upload">
								<label>
									...
									<span class="text-label">Прикрепить<br>портфолио</span>
...
<?endif;?>
		...
		<?endif?>
						<div class="form-submit">
							<button type="submit" name="iblock_submit" value="1">Отправить резюме</button>
						</div>
