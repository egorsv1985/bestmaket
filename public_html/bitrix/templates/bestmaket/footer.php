...
<?$APPLICATION->IncludeComponent("tkk:infoportal.element.add.form", "form-large", Array(
	"FORM_ID" => 'contactForm',
...
<!--			<h2>Послушайте записи наших сотрудников</h2>-->
<!--		--><?//
//		CModule::IncludeModule("iblock");
//		$arFilter = array("ACTIVE" => "Y", "IBLOCK_ID" => 21);
//
//
//		$rs=CIBlockElement::GetList(array('SORT' => 'ASC'), $arFilter, false, false, array("ID", "NAME", "SORT", "DETAIL_PAGE_URL", "PROPERTY_FILE"));
//		$i = 0;
//		while($ar=$rs->GetNext()):?>
<!--			<div class="audio-item--><?//=($i++%3 ? '' : ' clear')?><!-- audiofield">-->
<!--				<div class="audiofield-player">-->
<!--					<h3 for="audiofield-audio-player-file---><?//=$ar['ID'];?><!--">--><?//=$ar['NAME']?><!--</h3>-->
<!--					<audio id="audiofield-audio-player-file---><?//=$ar['ID'];?><!--" preload="none" controls  >-->
<!--						<source src="--><?//=CFile::GetPath($ar['PROPERTY_FILE_VALUE'])?><!--" type="audio/mpeg">-->
